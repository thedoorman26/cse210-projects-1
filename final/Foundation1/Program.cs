...
{
    /* For Creativity I added color, wait key pauses, I put thought into the display of info for each video so that details and 
    comment are easier to view and labeled each video with a number so you can see that you are working through each video detailed.
    */
    class Program
    {
